...
class $AssetsAnimationGen {
  ...
  /// File path: assets/animation/prayers.json
  LottieGenImage get prayers =>
      const LottieGenImage('assets/animation/prayers.json');

  /// List of all assets
  List<LottieGenImage> get values => [prayers];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/play_store.png
  AssetGenImage get playStore =>
      const AssetGenImage('assets/images/play_store.png');

  /// File path: assets/images/qibla_with_needle.svg
  SvgGenImage get qiblaWithNeedle =>
      const SvgGenImage('assets/images/qibla_with_needle.svg');
